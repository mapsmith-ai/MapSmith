...
resolves to the latest *archived* draft. These records declare `1.0.0-draft.8`; if the DOI shows
...
small fixes from the 0.7.0 audit, none reachable in the default configuration
